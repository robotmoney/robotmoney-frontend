...
export const STEPS: RolloutStep[] = [
  { id: "P2.rc-tag", phase: "P2 release identity", section: "§1", title: "an RC tag points at HEAD", hostRole: "any", actor: "operator", requires: [], dependsOn: [], derived: true, verify: "git tag --points-at HEAD -l 'v0.5.0-rc.*'" },
