// Unit tests for the pure decisions in backend/scripts/twin-capture.ts.
//
...
import { assertOutsideRepo, clientVersionComplaint, majorOf, parseArgs } from "../scripts/twin-capture.ts";
