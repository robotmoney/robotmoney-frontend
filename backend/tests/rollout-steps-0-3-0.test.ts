// Filesystem-only invariants for the retired v0.3.0 rollout implementation.
// Historical runbooks have been removed from the docs tree; these checks keep
// validating scripts and migration metadata without retaining old operator
...
describe("v0.3.0 rollout manifest invariants", () => {
