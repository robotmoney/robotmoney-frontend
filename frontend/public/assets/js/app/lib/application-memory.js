...
//
// The committee application id is minted server-side and handed to the operator
// exactly once: their agent prints `<host>/committee/apply/<uuid>` into a chat
// transcript (the committee-onboarding skill instructs it to, at its Step 3 and
...
// then on /committee/apply can offer a way back, and losing the chat message
...
const KEY = "rm:committee:application";
