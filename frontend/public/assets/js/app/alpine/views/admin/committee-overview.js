...
export function registerAdminCommitteeOverview(Alpine) {
  Alpine.data("adminCommitteeOverview", () => ({
    ...
    memberHref(id) { return path(`/admin/committee/members/:id`, { id }); },
    topicHref(id) { return path(`/admin/committee/subjects/:id`, { id }); },
    sessionHref(id) { return path(`/admin/committee/sessions/:id`, { id }); },
  }));
}
