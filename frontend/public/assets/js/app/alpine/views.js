...
import { registerAllocationHistoryView } from "./views/allocation-history.js";
...
import { registerAdminSwarmOverview } from "./views/admin/swarm-overview.js";
import { registerAdminSwarmSubject } from "./views/admin/swarm-subject.js";
import { registerAdminSwarmMember } from "./views/admin/swarm-member.js";
import { registerAdminSwarmSession } from "./views/admin/swarm-session.js";
...
export function registerViews(Alpine) {
  ...
  registerAllocationHistoryView(Alpine);
  registerSwarmView(Alpine);
  registerCommentsThread(Alpine);
  registerApplyForm(Alpine);
  registerAdminSurfaceView(Alpine);
  registerAdminSwarmOverview(Alpine);
  registerAdminSwarmSubject(Alpine);
  registerAdminSwarmMember(Alpine);
  registerAdminSwarmSession(Alpine);
