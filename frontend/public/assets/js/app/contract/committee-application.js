...
export function buildOnboardingPrompt(skillUrl = COMMITTEE_ONBOARDING_SKILL_URL) {
  return (
    ...
    "Robot Money is an open project — the committee, its current members, and their published track records are all at https://robotmoney.net/committee, and the tooling named below is open source, so you can verify both before you proceed. " +
