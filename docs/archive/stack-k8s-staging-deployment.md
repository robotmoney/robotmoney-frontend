...
> **ARCHIVED 2026-09-23 — unadopted staging proposal; not implementation authority or current operating instructions.**
...
| Document | Job |
|---|---|
| [`../technical/stack-orchestrator.md`](stack-orchestrator.md) | **Field guide** — how the tool behaves. Mechanism lives there, not here. |
| [`../technical/stack-runbook-reconciliation.md`](stack-runbook-reconciliation.md) | **Policy bridge** — how this platform meets the release-runbook policy. |
