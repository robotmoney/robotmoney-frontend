...
> **ARCHIVED 2026-09-23 — superseded engineering plan; not implementation authority or current operating instructions.**
...
> **Status: proposed, implements [`../technical/upgrade-deployment-spec.md`](upgrade-deployment-spec.md)
