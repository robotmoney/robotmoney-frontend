...
> **ARCHIVED 2026-09-23 — historical field guide for an unadopted tool; not implementation authority or current operating instructions.**
...
What we intend to do about it is [`../plans/stack-k8s-staging-deployment.md`](stack-k8s-staging-deployment.md);
