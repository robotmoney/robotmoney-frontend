...
> **ARCHIVED 2026-09-23 — superseded deployment design; not implementation authority or current operating instructions.**
...
> **⚠ Superseded on the credential model: see [`smoke-production-spec.md`](../technical/smoke-production-spec.md).**
...
> [`release-runbooks.md`](../technical/release-runbooks.md) §4 stands — and it does not
...
> [`../plans/deploy-separation-engineering-plan.md`](deploy-separation-engineering-plan.md).
>
