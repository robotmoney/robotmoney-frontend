...
// into the demo's standing driver, so both converge on ONE artifact
// directory, format, and redaction guarantee:
//
//   .agents/onboarding-evals/<composeProject>/<runId>/
//     manifest.json        — candidate identity, demo run, model, limits
 ...
 * (attempt 1's) — the one the demo's roster/pane already tracks — and
