...
export const PUBLIC_ENDPOINTS: AgentEndpoint[] = [
  ...
  },
  {
    ...
    description:
      "The ERC-4626 vault on Base: total value locked in USD, share price, deposit cap, and the per-adapter breakdown across Morpho, Aave and Compound. `asOf` is when the values were read onchain and `stale` says whether that read is older than the refresh interval, so a caller can decide for itself whether to quote the number.",
    backs: ["/allocation", "/"],
  ...
  },
  {
    ...
    summary: "Tracked-market summary counts and leaders",
    description: "Entity counts across agents, coins, vaults and wallets, the tracked vault TVL, the current leaders and the $ROBOTMONEY row.",
    backs: [],
  ...
  },
  {
    ...
    summary: "Unified agent / coin / vault / wallet table",
    description: "One row per tracked entity across all four facets, as the /list table renders them.",
    backs: [],
  ...
  },
  {
    ...
    summary: "Money-agent leaderboard with evidence",
    description:
  ...
  },
  {
    ...
    summary: "Tracked agent directory",
    description: "The tracked-agent directory rows plus a summary.",
    backs: [],
  ...
  },
  {
    ...
    summary: "Tracked coin directory",
    description: "Tracked coins with price and market data.",
    backs: [],
  ...
  },
  {
    ...
    summary: "Agent-managed vault directory",
    description: "Tracked agent-managed vaults, their strategy type and size.",
    backs: [],
  ...
  },
  {
    ...
    summary: "Tracked wallet directory",
    description: "Tracked and agent-derived wallets with balances.",
    backs: [],
  ...
  },
  {
    ...
    description: "The aggregated projects directory: one row per tracked project with its coin, wallet and vault facets.",
    backs: [],
