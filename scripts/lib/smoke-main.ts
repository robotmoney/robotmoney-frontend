...
// ); this file holds only the wiring. The scenario (`--smoke`: archive vs
// simulation data) is orthogonal to whether the boot seeds (`--seed`) and to
// where the database lives (`--db`).
