// Unit tests for scripts/lib/demo-newcomers.ts — the standing demo's FIXED,
...
// pre-check (see scripts/tests/unit/e2e-active-member-count.test.ts) — let the demo
...
import { NEWCOMER_LENSES, NEWCOMER_NAMES, plannedNewcomer } from "../../lib/demo-newcomers.ts";
