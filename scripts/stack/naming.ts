...
// because the four families can legitimately co-exist inside ONE CI job, where
// the env hash is by design identical for all of them.
//
...
export type StackRole = "stack" | "eval" | "infra" | "pgtest";
