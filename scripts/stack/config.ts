...
// The single definition of the compose file list in this repo. Consumed by the
// eval harness (scripts/lib/onboarding-eval.ts re-exports it for API
// compatibility) and by the rails check, which used to carry its own copy.
